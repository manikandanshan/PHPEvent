   ...
   if ($_POST['action_type'] == 'add' or $_POST['action_type'] == 'edit')
	...
	//Sanitize the data and assign to variables
        ...
        if ($_POST['action_type'] == 'add')
        {
				...
				$sql = "INSERT INTO advisoriesheader SET
						headers = '$category'";
...
header("Location: advisories_heading_list.php");
	exit();
}
...
if(isset($_POST["action"]) and $_POST["action"]=="edit")
{
	...
	include 'advisories_heading_edit.php';
	exit();
}
...
{
	$id = (isset($_POST["sn"])? $_POST["sn"] : '');
	$sql = "DELETE FROM advisoriesheader
			WHERE headers = '$id'";
...
include 'advisories_heading_list.php';
exit();
?>